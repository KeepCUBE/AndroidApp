...
package io.keepcube.kcapp.Tools.ColorPicker;
...
import io.keepcube.kcapp.Tools.ColorPicker.ColorPickerSwatch.OnColorSelectedListener;
...
public class ColorPickerPalette extends TableLayout {
    ...
    public void init(int size, int columns, OnColorSelectedListener listener) {
        ...
        mDescription = res.getString(R.string.select_color);
        mDescriptionSelected = res.getString(R.string.select_color);
    }
